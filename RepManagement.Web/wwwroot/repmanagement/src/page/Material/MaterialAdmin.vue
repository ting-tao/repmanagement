          ...
          <td style="padding: 5px 0;">
            ...
            >
              ...
              >
                ...
                <span style="float: right; color: #8492a6; font-size: 13px">{{ item.SerialNum }}</span>
              </el-option>
            </el-select>
          </td>
          <td class="name">克重：</td>
    ...
    <div class="table">
      <el-table ref="singleTable" :data="fiteredTableData" border highlight-current-row>
        ...
        <el-table-column label="用户操作" width="120">
          <template slot-scope="scope">
            <i class="el-icon-edit green operation" @click="editMaterial(scope.row,scope.$index)"></i>
        ...
        <el-row>
          ...
          <el-col :span="11">
            <el-form-item label="供应商" label-width="120px" prop="VendorID">
              <el-select class="w220" v-model="formData.VendorID" placeholder="请选择供应商">
                <el-option
                  v-for="item in vendorList"
                  :key="item.Id"
                  :label="item.VendorName"
