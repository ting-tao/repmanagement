                ...
                <el-table-column label="用户操作" width="120">
                    <template slot-scope="scope">
                        <i
                            ...
                            @click="editProduction(scope.row,scope.$index)"
                        ></i>
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="主料供应商" label-width="120px" prop="MainVendorId">
                            <el-select
                                class="w220"
                                v-model="formData.MainVendorId"
                                placeholder="请选择主料供应商"
                            >
                                <el-option
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="装饰供应商" label-width="120px" prop="DecorateVendorId">
                            <el-select
                                class="w220"
                                v-model="formData.DecorateVendorId"
                                placeholder="请选择装饰供应商"
                            >
                                <el-option
                                    v-for="item in vendorList"
                                    :key="item.Id"
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="汗带供应商" label-width="120px" prop="SweatbandVendorId">
                            <el-select
                                class="w220"
                                v-model="formData.SweatbandVendorId"
                                placeholder="请选择汗带供应商"
                            >
                                <el-option
                                    v-for="item in vendorList"
                                    :key="item.Id"
