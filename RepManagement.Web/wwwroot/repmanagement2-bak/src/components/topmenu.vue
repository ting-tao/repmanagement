      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
        <template v-for="(menuItem,index) in menuItems">
          ...
          <el-submenu :key="menuItem.index" :index="menuItem.index">
            ...
            <el-menu-item v-for="submenuItem in menuItem.submenuItems"  :class="submenuItem.nouse? 'nouse-menu':''" :key="index" :index="submenuItem.index">
...
export default {
  ...
  data() {
    return {
      preActive: '/material/admin',
      activeIndex: '/material/admin',
